  ...
  server.registerPrompt(
    "transcribe_and_summarize",
    {
      ...
      argsSchema: {
        ...
        diarize: z.string().optional().describe('"true" to label speakers when the account includes that entitlement.'),
      },
    },
    ({ source, focus, language, diarize }) => {
      ...
      const text =
        ...
        `(4) Report billed_minutes at the end. If a tool returns an insufficient-balance or unavailable-entitlement message, relay it to me and stop.`;
